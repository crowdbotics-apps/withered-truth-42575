"""
Django settings for withered_truth_42575 project.
...
ROOT_URLCONF = 'withered_truth_42575.urls'
...
WSGI_APPLICATION = 'withered_truth_42575.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_truth_42575 API",
    "DESCRIPTION": "API documentation for withered_truth_42575 App",
    "VERSION": "v1",
}
