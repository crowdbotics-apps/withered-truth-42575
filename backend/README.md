...
## Project Structure
    ...
    ├── withered_truth_42575  # Django project configurations
...
1. Clone this repo and `cd withered_truth_42575`
...
2. Clone this repo and `cd withered_truth_42575`
